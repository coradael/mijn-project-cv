  ...
  return (
    <div>
     ...
     <p style={{ lineHeight: '1.8', color: '#555' }}>
        Ik ben een enthousiaste developer met een groot doorzettingsvermogen. Met mijn
        sterke focus en creativiteit los ik complexe issues op. Ik vind het belangrijk om
